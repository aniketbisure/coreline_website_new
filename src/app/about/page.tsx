        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="aspect-video overflow-hidden rounded-xl border border-primary/30 shadow-lg shadow-primary/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
                className="bg-gradient-to-b from-black to-[#100500] p-8 rounded-xl border border-gray-800 hover:border-primary/30 transition-all duration-300"
              >
            ...
            {[
              ...
              >
                <div className="relative h-full w-full transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                  {/* Front of card */}
                  <div className="absolute inset-0 bg-black/30 rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 h-full w-full rounded-xl bg-gradient-to-b from-primary/20 to-black/90 [transform:rotateY(180deg)] [backface-visibility:hidden] p-6 flex flex-col justify-center items-center text-center">
                    ...
                    <div className="mt-4 flex gap-3"> 
                      <motion.button
                        ...
                        className="p-2 rounded-full bg-primary/20 hover:bg-primary/40"
                      >
